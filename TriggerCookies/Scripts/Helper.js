...
// Raw File:     https://github.com/nrensen/TriggerCookies/raw/master/TriggerCookies/Scripts/Helper.js
...
function LoadTriggerCookiesMod(name) {
	if (!IsModLoaded(name)) {
		Game.LoadMod('https://github.com/nrensen/TriggerCookies/raw/master/TriggerCookies/Scripts/' + name + '.js');
	}
}
