...
// Raw File:     https://github.com/nrensen/TriggerCookies/raw/master/TriggerCookies/Scripts/Live/EnhanceCookie.js
...
EnhanceCookie.ChangeTickerBackground = function () {
	if (EnhanceCookie.Actions['tickerbackground'].Enabled) {
		...
		l('comments').style.backgroundImage = "url('img/darkNoise.png')";
	}
	else {
