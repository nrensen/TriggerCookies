...
// Raw File:     https://github.com/nrensen/TriggerCookies/raw/master/TriggerCookies/Scripts/Live/CalcCookies.js
...
CalcCookie.RebuildUpgrades = function () {
	...
	for (var i in Game.UpgradesInStore) {
		...
		Game.clickStr + '="Game.UpgradesById[' + me.id + '].buy();" id="upgrade' + i + '" style="' + (me.icon[2] ? 'background-image:url(' + me.icon[2] + ');' : '') + 'background-position:' + (-me.icon[0] * 48 + 6) + 'px ' + (-me.icon[1] * 48 + 6) + 'px;">' +
		'<div id="upgradeBCI' + i + '" style="margin: 6px 0px 0px 6px; width: 0; height: 0; border-style: solid; border-width: 10px 10px 0 0; border-color: ' + me.bciColor + ' transparent transparent"></div>' +
		'</div>';
	...
	l('upgrades').innerHTML = toggleStr + storeStr;
